...
ffmpeg_path = "C:/PATH_programs/ffmpeg-4.3.2-2021-02-20-full_build/bin/ffmpeg.exe"
...
def extract_frames(ffmpeg_path, img_path, video_path, n_frames=10):
    ...
    failed_call = os.system('{} -i {} -framerate {} -vsync 0 -qscale:v 2 {}/%d.jpg'.format(ffmpeg_path,video_path, n_frames, img_path))
    if failed_call:
...
def frames_to_video(ffmpeg_path, img_path, video_path, n_images=1000):
    ...
    """
    error = ""
    print('{} -framerate 30 -i {}/image_at_epoch_{:d}.png -c:v libx264 -vf fps=30 -pix_fmt yuv420p {}/movie.mp4'.format(ffmpeg_path, img_path, n_images,video_path))
    failed_call = os.system('{} -framerate 30 -i {}/image_at_epoch_{:d}.png -c:v libx264 -vf fps=30 -pix_fmt yuv420p {}/movie.mp4'.format(ffmpeg_path, img_path, n_images,video_path))
    if failed_call:
...
img_path = 'compressed_images'
video_path = 'compressed_video'
frames_to_video(ffmpeg_path, img_path, video_path, n_images=10)